...
public class LoginController {
    ...
    @FXML
    private TextField txtBox_Player1;

    @FXML
    private TextField txtBox_Player2;
    ...
    public void actionOnClickLoginButton(ActionEvent event) throws IOException {
    	...
    	//checkersGUI.start(stage, txtBox_Player2.getText(),txtBox_Player1.getText());
    	 FXMLLoader fxmlLoader = new FXMLLoader();
		fxmlLoader.setLocation(getClass().getResource("/sprint1_prod/CheckersBoard.fxml"));

...
public class CheckersGUIComputer {
	...
	private void UpdateGameComputer() {
		...
		CheckGameOver(true);
		//check game over for computer player
		...
		if (overtakeMoves.size() > 0) {
			...
			if (computerPossibleMoves[0] != -1 && computerPossibleMoves[1] != -1) {
			...
			} else if (computerPossibleMoves[2] != -1 && computerPossibleMoves[3] != -1) {
				...
				if (computerPossibleMoves[4] != -1 && computerPossibleMoves[5] != -1) {
					...
					DoMove(fromRow, fromCol, computerPossibleMoves[4], computerPossibleMoves[5], piece);
				} else if (computerPossibleMoves[6] != -1 && computerPossibleMoves[7] != -1) {
					GridPane.setRowIndex(piece, computerPossibleMoves[6]);
					GridPane.setColumnIndex(piece, computerPossibleMoves[7]);
	...
	private void CheckGameOver(boolean isComputer) {
